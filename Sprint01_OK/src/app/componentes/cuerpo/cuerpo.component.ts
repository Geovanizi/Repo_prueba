...
export class CuerpoComponent implements OnInit {
  ...
  // nyeccion de dependencias en el constructor(miModal y miMensaje)
  ...
  public datosValidos(): boolean{
    ...
    this.miMensaje.error('No se puede crear el registro del carro sin llenar los campos', 'Advertencia',this.parametrosMensaje);
      return false;
    }
    return true;
  } 
